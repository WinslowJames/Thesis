...
In the last meeting, 3/26/2020, John and I talked about how these results are a bit crazy due to my formulation of the random effect being based on 'id'. 
However, for us to have a random effect it needs to be assigned to SOMETHING and I'm not sure what else to do in this situation.
